...
namespace Movieplayingwebsite.Repositories.Implement
{
    public class UserAuthenticationService : IUserAuthenticationService
    {
        ...
        public UserAuthenticationService(UserManager<ApplicationUser> userManager,
            SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, IHttpContextAccessor contxt)
        {
        ...
        public async Task<Status> LoginAsync(LoginModel model)
        {
            ...
            //3rd true will save the authentication information in cookie
